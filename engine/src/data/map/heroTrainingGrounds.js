module.exports = {
  ...
  rooms: {
    entrancePlaza: {
      ...
      exits: {
        n: '${self:map.heroTrainingGrounds.rooms.strengthAlley}',
        e: '${self:map.heroTrainingGrounds.rooms.intelligenceAvenue}',
        s: '${self:map.heroTrainingGrounds.rooms.courageCourtyard}',
        w: '${self:map.heroTrainingGrounds.rooms.agilityLane}',
      },
    },
    strengthAlley: {
      name: 'Strength Alley',
      ...
      exits: {
        s: '${self:map.heroTrainingGrounds.rooms.entrancePlaza}',
        n: '${self:map.heroTrainingGrounds.rooms.barracks}',
      },
    },
    agilityLane: {
      name: 'Agility Lane',
      ...
      exits: {
        e: '${self:map.heroTrainingGrounds.rooms.entrancePlaza}',
        w: '${self:map.heroTrainingGrounds.rooms.dormitory}',
      },
    },
    intelligenceAvenue: {
      ...
      exits: {
        w: '${self:map.heroTrainingGrounds.rooms.entrancePlaza}',
        e: '${self:map.heroTrainingGrounds.rooms.library}',
      },
    },
    courageCourtyard: {
      ...
      exits: {
        n: '${self:map.heroTrainingGrounds.rooms.entrancePlaza}',
        s: '${self:map.heroTrainingGrounds.rooms.temple}',
      },
    },
    barracks: {
      name: 'Barracks',
      ...
      exits: {
        s: '${self:map.heroTrainingGrounds.rooms.strengthAlley}',
      },
    },
    dormitory: {
      name: 'Dormitory',
      ...
      exits: {
        e: '${self:map.heroTrainingGrounds.rooms.agilityLane}',
      },
    },
    library: {
      name: 'Library',
      ...
      exits: {
        w: '${self:map.heroTrainingGrounds.rooms.intelligenceAvenue}',
      },
    },
    temple: {
      ...
      exits: {
        n: '${self:map.heroTrainingGrounds.rooms.courageCourtyard}',
      },
    },
  },
};
