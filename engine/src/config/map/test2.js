module.exports = {
  ...
  rooms: {
    entrancePlaza: {
      ...
      exits: {
        n: '${self:map.test2.rooms.strengthAlley}',
        e: '${self:map.test2.rooms.intelligenceAvenue}',
        s: '${self:map.test2.rooms.courageCourtyard}',
        w: '${self:map.test2.rooms.agilityLane}',
      },
    },
    strengthAlley: {
      name: 'Strength Alley',
      ...
      exits: {
        s: '${self:map.test2.rooms.entrancePlaza}',
        n: '${self:map.test2.rooms.barracks}',
      },
    },
    agilityLane: {
      name: 'Agility Lane',
      ...
      exits: {
        e: '${self:map.test2.rooms.entrancePlaza}',
        w: '${self:map.test2.rooms.dormitory}',
      },
    },
    intelligenceAvenue: {
      ...
      exits: {
        w: '${self:map.test2.rooms.entrancePlaza}',
        e: '${self:map.test2.rooms.library}',
      },
    },
    courageCourtyard: {
      ...
      exits: {
        n: '${self:map.test2.rooms.entrancePlaza}',
        s: '${self:map.test2.rooms.temple}',
      },
    },
    barracks: {
      name: 'Barracks',
      ...
      exits: {
        s: '${self:map.test2.rooms.strengthAlley}',
      },
    },
    dormitory: {
      name: 'Dormitory',
      ...
      exits: {
        e: '${self:map.test2.rooms.agilityLane}',
      },
    },
    library: {
      name: 'Library',
      ...
      exits: {
        w: '${self:map.test2.rooms.intelligenceAvenue}',
      },
    },
    temple: {
      ...
      exits: {
        n: '${self:map.test2.rooms.courageCourtyard}',
      },
    },
  },
};
