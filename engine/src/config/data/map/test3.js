module.exports = {
  ...
  rooms: {
    entrancePlaza: {
      ...
      exits: {
        n: '${self:map.test3.rooms.strengthAlley}',
        e: '${self:map.test3.rooms.intelligenceAvenue}',
        s: '${self:map.test3.rooms.courageCourtyard}',
        w: '${self:map.test3.rooms.agilityLane}',
      },
    },
    strengthAlley: {
      name: 'Strength Alley',
      ...
      exits: {
        s: '${self:map.test3.rooms.entrancePlaza}',
        n: '${self:map.test3.rooms.barracks}',
      },
    },
    agilityLane: {
      name: 'Agility Lane',
      ...
      exits: {
        e: '${self:map.test3.rooms.entrancePlaza}',
        w: '${self:map.test3.rooms.dormitory}',
      },
    },
    intelligenceAvenue: {
      ...
      exits: {
        w: '${self:map.test3.rooms.entrancePlaza}',
        e: '${self:map.test3.rooms.library}',
      },
    },
    courageCourtyard: {
      ...
      exits: {
        n: '${self:map.test3.rooms.entrancePlaza}',
        s: '${self:map.test3.rooms.temple}',
      },
    },
    barracks: {
      name: 'Barracks',
      ...
      exits: {
        s: '${self:map.test3.rooms.strengthAlley}',
      },
    },
    dormitory: {
      name: 'Dormitory',
      ...
      exits: {
        e: '${self:map.test3.rooms.agilityLane}',
      },
    },
    library: {
      name: 'Library',
      ...
      exits: {
        w: '${self:map.test3.rooms.intelligenceAvenue}',
      },
    },
    temple: {
      ...
      exits: {
        n: '${self:map.test3.rooms.courageCourtyard}',
      },
    },
  },
};
