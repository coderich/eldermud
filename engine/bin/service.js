    ...
    map: {
      ...
      function: {
        ...
        description: `
          ...
          Every reference to a room must be defined.
          Pathways and structures must be defined using multiple rooms to convey size and shape.
          You must ensure all rooms can be traversed both backwards and forwards.
        `,
        parameters: {
          type: 'object',
          properties: {
            ...
            'map.$key.rooms.$key.terrain': { type: 'string', enum: ['pavement', 'gravel', 'dirt', 'sand', 'water', 'lava'] },
